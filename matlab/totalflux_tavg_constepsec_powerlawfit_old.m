...
% fitval4=a(4).*exp(-b(4).*(f1fit4.^2))+c(4);
fitval2=a(2).*f1fit2.^b(2)+c(2);
...
% 
%  plot((periodvalues(1:6,1)),log10(erat00_2Mm(1:6)),'o',(periodvalues(1:6,2)),log10(erat01_2Mm(1:6)),'+',(periodvalues(1:6,3)),log10(erat02_2Mm(1:6)),'x',(periodvalues(1:6,4)),log10(erat03_2Mm(1:6)),'s');
 plot((periodvalues(1:6,1)),log10(erat00_4Mm(1:6)),'o');
pervals=periodvalues(1:6,1);
powvals=erat00_2Mm(1:6);
% 
...
% % 
%  plot(log10(f1fit4),log10(fitval4),'x');

 plot((f1fit1),log10(fitval1),'+');
% 
 plot((f1fit2),log10(fitval2),'x');

plot((f1fit4),log10(fitval4),'-');
