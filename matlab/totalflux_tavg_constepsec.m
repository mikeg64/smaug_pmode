...
%(0,0) mode
efluxcoronaavg(:,1)=[542.5186; 1.4353e5; 4.0302e3; ; ; 7.8956e6; 7.9381e4];
efluxtranavg(:,1)=[5.0191e4; 3.7837e7;1.3437e8 ; ; ; 9.0611e7;  1.1122e7];
efluxchromavg(:,1)=[2.9484e5; -1.0457e7;4.1129e10 ; ; ; 1.2814e7; -4.8432e6];

%20,42,90,117
ef1Mm(:,1)=[860.1025 ;2.05e5 ;1.8527e5 ; ; ; 6.2586e6; 1.0498e5 ];
ef2Mm(:,1)=[11.1565 ; 6.4033e3; 4.4367e4 ; ; ; 1.7128e4; 2.118e3 ];
ef4Mm(:,1)=[6.8201 ; 1.7107e3; 1.6621e4 ; ; ; 9.8941e3; 975.1936 ];
ef5p5Mm(:,1)=[3.5777; 879.9814; 8.5293e3 ; ; ; 5.1971e3; 517.0635 ];
