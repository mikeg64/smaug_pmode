...
% 300s driver
 for i=1:1:1176
         ...
         directory='/fastdata/cs1mkg/smaug/spic1p53a_0_3_3d/';
%        directory='/fastdata/cs1mkg/smaug/fastdata/cs1mkg/smaug/spic5b2_2/';

extension='.out';

ndirectory='/fastdata/cs1mkg/smaug/spic1p53a_0_3_3d/images_comp/';
...
title(gca,{'Slices for Vz (m/s), Velocity Vectors and 2e6K isosurface';'Driver Period 153s, Normal Mode 0,3 '});      
