...
%(0,0) mode
efluxcoronaavg(:,1)=[631.2369; 5.9662e4; 5.5733e6 ;3.0037e4 ; 0; 0];
efluxtranavg(:,1)=[5.6011e4; 1.3652e4; 9.6167e8 ;2.8300e7 ; 0; 0];
efluxchromavg(:,1)=[3.0578e5; -2.7388e6; 5.2853e7 ;-8.3555e6 ; 0; 0];

%20,42,90,117
ef1Mm(:,1)=[966.0016; 9.377e4; 3.1342e6 ;1.2418e5 ; 0; 0 ];
ef2Mm(:,1)=[12.5077; 1.7191e3; 1.5851e5 ;2.2957e3 ; 0; 0 ];
ef4Mm(:,1)=[7.9025; 733.8413; 6.7922e4 ;340.7484 ; 0; 0 ];
ef5p5Mm(:,1)=[4.2109; 379.3476; 3.5415e4 ;180.6875 ; 0; 0 ];
