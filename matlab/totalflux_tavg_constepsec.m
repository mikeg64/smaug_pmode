...
%(0,0) mode
efluxcoronaavg(:,1)=[3.0387e5; 1.4347e5;1.1565e7;0;1.4329e4;0;9.6496e4];
efluxtranavg(:,1)=[ 4.8017e7;3.1722e7;2.1462e9;0;9.178e3;0;1.3388e7];
efluxchromavg(:,1)=[ 4.2168e8;-1.2637e7;1.2586e8;0;-4.3964e6;0;-5.8949e6];

%20,42,90,117
ef1Mm(:,1)=[ 5.791e6,1.361e5;7.5246e6;0;5.3737e4;0;1.2923e5 ];
ef2Mm(:,1)=[ 1.198e4;4.5765e3;4.5954e5;0;1.059e3;0;2.555e3 ];
ef4Mm(:,1)=[ 3.7012e3;1.7332e3;1.285e5;0;162.2969;0;1.1844e3 ];
ef5p5Mm(:,1)=[ 1.9125e3;890.9615;6.7592e4;0;84.9070;0;627.9517];
