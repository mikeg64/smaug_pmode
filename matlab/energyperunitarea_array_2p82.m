...
directory='/fastdata/cs1mkg/smaug/spic2p82a_0_0_3d/';
...
ndirectory='/fastdata/cs1mkg/smaug/spic2p82a_0_0_3d/images';
...
wspacename='s2p82a_0_0_matlab_perturb.mat';
...
if i>(iper)
    if i<nt-iper
ef0p5Mmv(i-iper)= sum(efluxarray(i:i+iper , 11))/iper;  %11
ef1Mmv(i-iper)= sum(efluxarray(i:i+iper , 20))/iper;  %20
ef2Mmv(i-iper)=sum(efluxarray(i:i+iper , 42))/iper;  %42
ef4Mmv(i-iper)=sum(efluxarray(i:i+iper , 90))/iper;  %90
ef5p5Mmv(i-iper)=sum(efluxarray( i:i+iper, 117))/iper; %117
    end
