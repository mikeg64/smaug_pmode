...
wspacename=['/fastdata/cs1mkg/smaug/matlabdat/',rdirectory,'_ydir_vverustime_0p5Mm.mat']
...
%  x-direction    
%   evelchrom_vh(i,:)=myval( :,15,20);  %  horizontal section in chrom at  20
%   eveltran_vh(i,:)=myval( :,15,42);   %  horizontal section in transition layer at 42
%   evelcor_vh(i,:)=myval( :,15,90);    %  horizontal section in corona at 90

%   evel2Mm_vh(i,:)=myval(62,15,:);  %vertical section at 2Mm  62
%   evel1Mm_vh(i,:)=myval(31,15,:);  %vertical section at 1Mm  31
%   evelp5Mm_vh(i,:)=myval(15,15,:);  %vertical section at 0.5Mm 15
     ...
     evelcor_vh(i,:)=myval( 15,:,90);    %  horizontal section in corona at 90
% 
     evel2Mm_vh(i,:)=myval(15,62,:);  %vertical section at 2Mm  62
     evel1Mm_vh(i,:)=myval(15,31,:);  %vertical section at 1Mm  31
     evelp5Mm_vh(i,:)=myval(15,15,:);  %vertical section at 0.5Mm 15
