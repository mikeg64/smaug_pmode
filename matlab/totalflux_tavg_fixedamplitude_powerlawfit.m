...
%(0,0) mode
efluxcoronaavg(:,1)=[631.2369; 5.9778e+04; 5.5733e6 ;3.0037e4 ; 7.8956e6; 7.9381e4];
efluxtranavg(:,1)=[5.6011e4; 1.7168e+07; 9.6167e8 ;2.8300e7 ; 9.0611e7;  1.1122e7];
efluxchromavg(:,1)=[3.0578e5; -2.963e6; 5.2853e7 ;-8.3555e6 ; 1.2814e7; -4.8432e6];

%20,42,90,117
ef1Mm(:,1)=[966.0016; 7.1616e+04; 3.1342e6 ;1.2418e5 ; 6.2586e6; 1.0498e5 ];
ef2Mm(:,1)=[12.5077; 1.6954e+03; 1.5851e5 ;2.2957e3 ; 1.7128e4; 2.118e3 ];
ef4Mm(:,1)=[7.9025; 7.365235e+02; 6.7922e4 ;340.7484 ; 9.8941e3; 975.1936 ];
ef5p5Mm(:,1)=[4.2109; 3.782955e+02; 3.5415e4 ;180.6875 ; 5.1971e3; 517.0635 ];
...
%20,42,90,117
ef1Mm(:,4)=[ 3.259072103326768e+02; 3.893404121122640e+05; 8.438982957947100e+05 ;6.379451068678251e+05 ; 2.666037590733403e+04; 1.741670556387822e+05 ];
...
plot((periodvalues(1:6,1)),log10(ef5p5Mm(:,1)./ef2Mm(:,1)),'+');
pervals=periodvalues(1:6,1);
powvals=ef5p5Mm(:,1);

 hold on;
 plot((f1fit1),log10(fitval2./fitval1),'o');
% 
 plot((f1fit4),log10(fitval4./fitval5),'x');
